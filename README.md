...
| Role    | Face    | Notes                                                              |
| ------- | ------- | ------------------------------------------------------------------ |
| Unified | Raleway | Headings, eyebrows, body, and UI — single luxury geometric sans    |

Served from Google Fonts across weights 300 to 700 with italics. `css/type.css` holds
the fluid scale, letter-spacing and figure settings; `css/tokens.css` holds colour and spacing.
...
- [x] Premium luxury single-font type system (Raleway) on brand gold `#c5a880`
